...
const SideBar = () => {
    return (
      <aside
        className="min-h-screen pt-4 md:px-1 px-0 w-0 md:w-60 text-white bg-gray-900 
      ...
      >
        ...
        <div className="text-left">
          <NavLink
            className="flex mx-2 my-1 rounded p-2 hover:bg-gray-800"
          ...
          <div className="mt-5 pl-4">
            <a
              href="//add link to your github repo"
